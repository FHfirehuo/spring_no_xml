...
public class WebInitializer { // implements WebApplicationInitializer
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		webApplicationContext.register(WebConfig.class, JPAConfig.class); // AopConfig.class,
																			// ProfileConfig.class,
		webApplicationContext.setServletContext(servletContext);

		/***
		 * //感觉没有任何意义，仅供了解 ///后来发现这个不行 必须使用AnnotationConfigApplicationContext
		 * 而不是AnnotationConfigWebApplicationContext
		...
		// WebApplicationContextUtils.getRequiredWebApplicationContext(servletContext).getBean(ConfigFactory.class);
		// config.SayHello();
